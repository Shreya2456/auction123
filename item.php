    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="auctions.php?category=1" class="relative h-60 rounded-lg overflow-hidden group">
                <img src="https://www.mrporter.com/variants/images/1647597282779954/in/w2000_q60.jpg" alt="Clothes" class="w-full h-full object-cover group-hover:scale-105 transition-all duration-300">
